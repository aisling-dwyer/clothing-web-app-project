...
public class OrderController {
        ...
        @GetMapping(value = "/{userIdString}/orders")
        //    @PreAuthorize("hasAuthority('ROLE_USER')")
        public ResponseEntity<List<OrderDTO>> getUserOrders(@PathVariable String userIdString) {
                ObjectId userId = new ObjectId(userIdString);
                return new ResponseEntity<List<OrderDTO>>(orderService.getUserOrdersList(userId), HttpStatus.OK);
        }
